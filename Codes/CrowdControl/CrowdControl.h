...
enum CCEffect
{
    ...
    EFFECT_ATTRIBUTE_NUMJUMPS = 37,
    EFFECT_ATTRIBUTE_JUMPSQUAT = 38,
    EFFECT_ATTRIBUTE_GROUNDFRICTION = 39,
    EFFECT_ATTRIBUTE_GRAVITY = 40,
    EFFECT_ATTRIBUTE_FASTFALLSPEED = 41,
    EFFECT_ATTRIBUTE_WEIGHT = 42,
};

...
struct FontData {
    VTABLE_METHOD(FontData*, s32, GetWidth)
    VTABLE_METHOD(FontData*, s32, GetHeight)
    VTABLE_METHOD(FontData*, s32, GetAscent)
    VTABLE_METHOD(FontData*, s32, GetDescent)
    VTABLE_METHOD(FontData*, s32, GetBaselinePos)
    VTABLE_METHOD(FontData*, s32, GetCellHeight)
    VTABLE_METHOD(FontData*, s32, GetCellWidth)
    VTABLE_METHOD(FontData*, s32, GetMaxCharWidth)
    VTABLE_METHOD(FontData*, s32, GetType)
    VTABLE_METHOD(FontData*, s32, GetTextureFormat)
    VTABLE_METHOD(FontData*, s32, GetLineFeed)
    VTABLE_METHOD(FontData*, s32, GetDefaultCharWidths)
    VTABLE_METHOD(FontData*, s32, SetDefaultCharWidths)
    VTABLE_METHOD(FontData*, s32, SetAlternateChar)
    VTABLE_METHOD(FontData*, s32, SetLineFeed)
    VTABLE_METHOD(FontData*, s32, GetCharWidth)
    VTABLE_METHOD(FontData*, s32, GetCharWidths)
    VTABLE_METHOD(FontData*, s32, GetGlyph)
    VTABLE_METHOD(FontData*, s32, GetEncoding)
